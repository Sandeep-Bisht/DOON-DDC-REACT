  ...
  <section className="contact-single shop-description">
    ...
    <div className="row">
        <div className="col-md-6">
            ...
            The Doon Digestive Diseases Center has top notch infrastructure with state-of-the-art and sophisticated technology. 
            And apart from being equipped with the best medical facilities, it is Human Touch & Care by which the hospital has been 
            able to gain trust of people.
            </p>
