    ...
    <>
      <footer className="footer-page">
            ...
            <div className="col-md-3">
              ...
              <div className="footer-contact-icons">
                ...
                <address className="footer-content">
                  Digestive Disease Centre, 2, Gms Road, Dehradun City, dehradun
                  - 248001 (Ankit Puram, Near Chaudhary Farm House)
                </address>
                </div>
              ...
              <div className="footer-contact-icons">
                ...
                <div className="footer-contact-details">
                <p className="footer-content">07947125870</p>
        ...
        <div className="copyright">
            <p className="mb-0">Designed & Developed By <span className="developed-by"><Link>GIKS India Pvt Ltd</Link></span></p>
        </div>
      </footer>
    </>
  );
